"""
Django settings for github_check_5 project.
...
ROOT_URLCONF = 'github_check_5.urls'
...
WSGI_APPLICATION = 'github_check_5.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "github_check_5 API",
    "DESCRIPTION": "API documentation for github_check_5 App",
    "VERSION": "v1",
}
